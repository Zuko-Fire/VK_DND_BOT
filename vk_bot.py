...
class VkBot:
    ...
    def __init__(self, user_id):
        ...
        self._COMMANDS = ["ПРИВЕТ", "ПОГОДА", "ВРЕМЯ", "ПОКА","БЕСТИАРИЙ","РАНДОМ СУЩЕСТВО"]
    ...
    def new_message(self, message):
        ...
        # Пока
            ...
            return dndParser.search(message.upper())
        elif self._COMMANDS[5] == message.upper():
            return dndParser.randomCreature()
